...
for row in rows:
    ...
    # Convert raw weight to float; set to None if invalid or missing
    try:
    ...
    # Convert raw height to float; set to None if invalid or missing
    try:
    ...
    # No WHO adjustment — use the height as-is
